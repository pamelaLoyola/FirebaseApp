...
const categories = [
  {
    ...
    children: [
      ...
      { id: 'Mis preguntas', icon: <DnsRoundedIcon /> },
    //   { id: 'Storage', icon: <PermMediaOutlinedIcon /> },
      { id: 'Destacado', icon: <PublicIcon /> },
      { id: 'Mis funciones', icon: <SettingsEthernetIcon /> },
      { id: 'Logros', icon: <SettingsInputComponentIcon /> },
    ],
  },
  {
    id: 'Cuenta',
